...
public class PowerPlayAutoOpMode extends OpMode {
    ...
    @Override
    public void start() {
        behaviors.add(new CloseClaw(telemetry, "Close Claw", robot.getClaw()));
        behaviors.add(new RaiseLift(telemetry, "raise lift to travel", robot, JunctionType.TRAVEL));
        ...
        if (startingLocation == StartingLocation.FRONT && allianceColor == AllianceColor.BLUE) {
            ...
            behaviors.add(new DriveHeading(telemetry, "drive forward at -90°", robot, -90, robot.calculateDriveTicks(20), 0.25));
            behaviors.add(new TurnToHeading(telemetry, "turn left to -45°", robot, -45));
            behaviors.add(new RaiseLift(telemetry, "raise lift to high", robot, JunctionType.HIGH));
            behaviors.add(new DriveHeading(telemetry, "drive forward at -45°", robot, -45, robot.calculateDriveTicks(8), 0.1));
            behaviors.add(new OpenClaw(telemetry, "Open Claw", robot.getClaw()));
            behaviors.add(new ReverseHeading(telemetry, "drive backward", robot, 45, -robot.calculateDriveTicks(8), -0.1));
            behaviors.add(new LowerLift(telemetry, "lower lift to ground", robot, JunctionType.TRAVEL));
            behaviors.add(new TurnToHeading(telemetry, "turn right to 90°", robot, -90));

            switch (signalSide) {
                case ONE:
                    behaviors.add(new DriveHeading(telemetry, "drive forward", robot, -90, -robot.calculateDriveTicks(2), 0.25));
                    break;
                case TWO:
                    behaviors.add(new ReverseHeading(telemetry, "drive backward", robot, 90, -robot.calculateDriveTicks(22), -0.25));
                    break;
                case THREE:
            ...
            behaviors.add(new TurnToHeading(telemetry, "turn right to 90°", robot, 90));
            behaviors.add(new DriveHeading(telemetry, "drive forward at 90°", robot, 90, robot.calculateDriveTicks(20), 0.25));
            behaviors.add(new TurnToHeading(telemetry, "turn left to 45°", robot, 40));
            behaviors.add(new RaiseLift(telemetry, "raise lift to high", robot, JunctionType.HIGH));
            behaviors.add(new DriveHeading(telemetry, "drive forward at 45°", robot, 40, robot.calculateDriveTicks(8), 0.1));
            behaviors.add(new OpenClaw(telemetry, "Open Claw", robot.getClaw()));
            behaviors.add(new ReverseHeading(telemetry, "drive backward", robot, -40, -robot.calculateDriveTicks(8), -0.1));
            behaviors.add(new LowerLift(telemetry, "lower lift to ground", robot, JunctionType.TRAVEL));
            behaviors.add(new TurnToHeading(telemetry, "turn right to 90°", robot, 90));
            ...
            behaviors.add(new TurnToHeading(telemetry, "turn right to -90°", robot, -90));
            behaviors.add(new DriveHeading(telemetry, "drive forward at -90°", robot, -90, robot.calculateDriveTicks(20), 0.25));
            behaviors.add(new TurnToHeading(telemetry, "turn left to -40°", robot, -40));
            behaviors.add(new RaiseLift(telemetry, "raise lift to high", robot, JunctionType.HIGH));
            behaviors.add(new DriveHeading(telemetry, "drive forward at -45°", robot, -40, robot.calculateDriveTicks(8), 0.1));
            behaviors.add(new OpenClaw(telemetry, "Open Claw", robot.getClaw()));
            behaviors.add(new ReverseHeading(telemetry, "drive backward", robot, 40, -robot.calculateDriveTicks(8), -0.1));
        ...
        behaviors.add(new LowerLift(telemetry, "lower lift to ground", robot, JunctionType.GROUND));
